using Content.Shared._PS.CrateMachine;
using Content.Shared._PS.CrateMachine.Components;
using Content.Shared._PS.CrateMachine.Systems;
using Content.Server.Power.Components;
using AppearanceSystem = Robust.Server.GameObjects.AppearanceSystem;
using CrateMachineComponent = Content.Shared._PS.CrateMachine.Components.CrateMachineComponent;
