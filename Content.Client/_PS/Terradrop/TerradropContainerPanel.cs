...
public sealed class TerradropContainerPanel : LayoutContainer
{
        ...
        foreach (var child in Children)
        {
            ...
            // {
                ...
                foreach (var prerequisiteItem in prerequisiteItems)
                {
                    ...
                    DrawConfigurableConnection(handle, startCoords, endCoords, lineColor);
            //    }
            }
        }
    }
    ...
    /// </summary>
    private void DrawConfigurableConnection(DrawingHandleScreen handle, Vector2 start, Vector2 end, Color color)
    {
        var delta = end - start;
        var distance = delta.Length();
