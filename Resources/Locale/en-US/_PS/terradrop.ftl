...
terradrop-console-prereqs-list-entry = - [color=orchid]{$text}[/color]
terradrop-console-unlocks-list-start = Unlocks:
terradrop-console-unlocks-list-entry = - [color=yellow]{$name}[/color]
...
terradrop-map-recharis = Recharis
terradrop-map-obscyra = Obscyra
terradrop-map-ebonis = Ebonis
terradrop-map-crimsonis = Crimsonis
terradrop-map-bastara = Bastara
terradrop-map-crownis = Crownis
terradrop-map-ferros = Ferros
